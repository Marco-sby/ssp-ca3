...
router.use(express.static(path.resolve(__dirname,'bookproject'))); //We serve static content from "views" folder
...
router.get('/', function(req, res) {
    ...
    let xml = fs.readFileSync('bookStore.xml', 'utf8'),
        xsl = fs.readFileSync('bookStore.xsl', 'utf8');
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        XMLtoJSON('bookStore.xml', function (err, result) {
            if (err) throw (err);
            ...
            JSONtoXML('bookStore.xml', result, function(err){
